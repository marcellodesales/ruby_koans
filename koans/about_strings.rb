...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    #
    # As the the shovel << operator modifies the original reference, it is
    # more performant than the += operator because this operation will create
    # a new object for the concatenation.
  end
  ...
  def test_you_can_get_a_substring_from_a_string
    ...
    assert_equal "let", string[7..9] ########################> Pay attention to the ranges!!!!
  end
  ...
  def test_strings_are_unique_objects
    ...
    assert_equal true, a           == b  ##############> State is the same, but STILL IDs are different
