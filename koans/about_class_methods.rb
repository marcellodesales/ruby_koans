...
class AboutClassMethods < EdgeCase::Koan
  ...
  #
  # In one hand, I prefer "self" over the other because it is more
  # clear when reading code. The operator "<<" is usually used in
  # collections and that would make the code read more difficult.
  #
  # Are there times you might prefer one over the other?
  #
  # That's the "however part". If there's a way to use the operator
  # "<<" to dynamically add methods to classes, then I would think
  # that this operator is the one option.
