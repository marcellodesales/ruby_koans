...
class AboutIteration < EdgeCase::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    #
    # Inject gives a initial value to the first parameter "sum",
    # while computing the block for all elements. It will return
    # the accumulated value of the first parameter "sum".
  end
  ...
  #   # code to read 'file'
  #
  # Because the block dictates when the file stream can be closed 
  # automatically. With the reference, the programmer has the responsibility
  # to close it. ?
  #
